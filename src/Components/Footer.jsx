...
const Footer = () => {
  return (
    <>
      <footer className="relative bg-cover bg-fixed bg-center bg-no-repeat z-10 pb-10 pt-20 dark:bg-dark lg:pb-4 lg:pt-[120px]" style={{ backgroundImage: `url(${footer})` }} >
        <div className="container mx-auto md:px-10 px-5 md:text-start text-center">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                <Link to={'/'} className="font-bold text-lg md:text-4xl gap-3 flex items-center">
                ...
                <p className="flex md:justify-start justify-center items-center text-sm font-medium text-dark dark:text-white">
        ...
        {/* Copyright */}
        <div className="footer footer-center text-gray-200 pt-4 pb-3 border-t">
                <aside>
...
const NavLink = ({ link, label }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-base leading-loose text-body-color hover:text-[#fe9703] dark:text-dark-6"
      >
        {label}
      </a>
    </li>
