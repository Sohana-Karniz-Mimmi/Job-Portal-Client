    ...
    return (
        <section className="relative mb-16 bg-cover bg-center bg-no-repeat h-[222px]" style={{
          ...
          >
            ...
            <div className=" container lg:flex items-center justify-between h-[222px] py-4 px-2 mx-auto max-w-screen-xl sm:py-4 lg:px-32 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 text-white">
